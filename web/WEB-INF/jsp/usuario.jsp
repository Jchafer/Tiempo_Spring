                    ...
                    <form action="<%=urlAction%>" method="post" >
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input class="input-xlarge" id="Id" name="Id" type="text" placeholder="Auto-Increment" value="${usuario.id}" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="nombre">Nombre:</label>
                                <input class="input-xlarge" id="nombre" type="text" name="txtnom" value="${usuario.nombres}" >
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="correo">Email:</label>
                                <input class="input-xlarge" id="correo" type="text" name="txtcorreo" placeholder="example@hotmail.com" value="${usuario.correo}" >
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn" href="<%=request.getContextPath()%>/usuarioListado.html?usuPass=<%=usuario.getId()%>" >Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
