...
<%
    ...
    switch (formOperation) {
        case Insert:
            ...
            urlAction = request.getContextPath() + "/dia/insert.html";
            break;
        case Update:
            labelButton = "Actualizar";
            urlAction = request.getContextPath() + "/dia/update.html";
            break;
        case Delete:
            labelButton = "Borrar";
            urlAction = request.getContextPath() + "/dia/delete.html";
            break;
        default:
                    ...
                    <form action="<%=urlAction%>" method="post" >
                        <fieldset>
                            <div class="form-group">
                                <label class="control-label" for="idDia">Id:</label>
                                <input class="input-xlarge " id="idDia" name="idDia" type="text" placeholder="Auto-Increment" value="${dia.idDia}" readonly="readonly">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="poblacion">Población:</label>
                                <input class="input-xlarge" id="poblacion" type="text" name="poblacion" value="${dia.poblacion}" >
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="fecha">Fecha:</label>
                                <input class="input-xlarge" id="fecha" type="text" name="fecha" placeholder="yyyy-MM-dd" value="${dia.fecha}" >
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="tempMaxima">Temperatura máxima:</label>
                                <input class="input-xlarge" id="tempMaxima" type="text" name="tempMaxima" value="${dia.tempMaxima}" >
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="tempMinima">Temperatura mínima:</label>
                                <input class="input-xlarge" id="tempMinima" type="text" name="tempMinima" value="${dia.tempMinima}" >
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn" href="<%=request.getContextPath()%>/dia.html?usuPass=<%=usuario.getId()%>" >Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
